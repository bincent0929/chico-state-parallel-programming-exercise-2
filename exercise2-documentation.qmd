...
# primepi was not working so I just checked to verify it on
# t5k online.
# 50,847,534 primes ≤ 1 billion is a well-known, published result
# (see https://t5k.org/howmany.html)

print(prevprime(1000000000))
print(prevprime(999999937))

for sp in [35, 376223, 4006336753, 406615978649, 4154092115820191, 418155269059864129]:
    print(f"{sp} = {factorint(sp)}")
```
...
!!! I did make sure and place the timing collectors before and after the segment which includes the I/O and the rest of the logic for processing the images !!!
