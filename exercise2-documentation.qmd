...
``` {python}
n-parallel-rotation-t = 0.110802
parallel-rotation-t = 0.035044

rotation-speedup = n-parallel-rotation-t / parallel-rotation-t
```

Which is a `{python} rotation-speedup`x speedup!!!
