...
{::: {.callout-warning}
I need to go back and create a function that finds this:
...
Basically, just to have it find the primes in the prime list and then have is calculate the semiprime. And maybe feeding these into my logic for finding the primes from the semiprime but I'm unsure of whether I need to do that.
:::}
...
The reverse search using the semiprime and the prime list worked!
Like above the primes were: 1299721, and 15485867 for 20127306543107
```

As you can see, largest primes were 999999937 and then 999999929.

The semiprime I calculated was 20127306543107 and my program effectively found its first prime, 1299721 using a parallelized `for` loop. See `eratosthenes-parallel/eratosomp.c` for the logic.

{::: {.callout-warning}
I need to do a speed up comparison. I think I'll just use the `time` bash function to do it.
:::}
